...
import sty from "./PlasmicButton.module.css"; // plasmic-import: EUHAWQvqEbnMq/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__tr89O)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___7VE8B)}
                role={"img"}
              />
            ),
